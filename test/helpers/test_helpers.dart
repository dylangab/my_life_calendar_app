...
void registerServices() {
  ...
  getAndRegisterCalendarServiceService();
  getAndRegisterHiveApiService();
...
MockCalendarServiceService getAndRegisterCalendarServiceService() {
  _removeRegistrationIfExists<CalendarServiceService>();
  final service = MockCalendarServiceService();
  locator.registerSingleton<CalendarServiceService>(service);
  return service;
}
