...
final Map<String, TextEditingController>
    _AddMilestoneSheetTextEditingControllers = {};

final Map<String, FocusNode> _AddMilestoneSheetFocusNodes = {};

final Map<String, String? Function(String?)?>
    _AddMilestoneSheetTextValidations = {
  TitleValueKey: null,
  DescriptionValueKey: null,
};

mixin $AddMilestoneSheet {
  ...
  TextEditingController _getFormTextEditingController(
    ...
    if (_AddMilestoneSheetTextEditingControllers.containsKey(key)) {
      return _AddMilestoneSheetTextEditingControllers[key]!;
    }

    _AddMilestoneSheetTextEditingControllers[key] =
        TextEditingController(text: initialValue);
    return _AddMilestoneSheetTextEditingControllers[key]!;
  }

  FocusNode _getFormFocusNode(String key) {
    if (_AddMilestoneSheetFocusNodes.containsKey(key)) {
      return _AddMilestoneSheetFocusNodes[key]!;
    }
    _AddMilestoneSheetFocusNodes[key] = FocusNode();
    return _AddMilestoneSheetFocusNodes[key]!;
  }
  ...
  void disposeForm() {
    ...
    for (var controller in _AddMilestoneSheetTextEditingControllers.values) {
      controller.dispose();
    }
    for (var focusNode in _AddMilestoneSheetFocusNodes.values) {
      focusNode.dispose();
    }

    _AddMilestoneSheetTextEditingControllers.clear();
    _AddMilestoneSheetFocusNodes.clear();
  }
}
...
extension ValueProperties on FormStateHelper {
  ...
  set titleValue(String? value) {
    ...
    if (_AddMilestoneSheetTextEditingControllers.containsKey(TitleValueKey)) {
      _AddMilestoneSheetTextEditingControllers[TitleValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set descriptionValue(String? value) {
    ...
    if (_AddMilestoneSheetTextEditingControllers.containsKey(
        DescriptionValueKey)) {
      _AddMilestoneSheetTextEditingControllers[DescriptionValueKey]?.text =
          value ?? '';
    }
  }
...
String? getValidationMessage(String key) {
  final validatorForKey = _AddMilestoneSheetTextValidations[key];
  if (validatorForKey == null) return null;

  String? validationMessageForKey = validatorForKey(
    _AddMilestoneSheetTextEditingControllers[key]!.text,
  );
